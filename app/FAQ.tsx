    ...
    <div className="w-full px-4 py-12 bg-transparent">
      ...
      <div className="max-w-3xl mx-auto">
        {faqData.map((faq, index) => {
          // measure the content’s scrollHeight
          const contentHeight =
          ...
          return (
            <div key={index} className="border-b border-gray-300 py-4">
              ...
              <div
                // Use a callback ref to store each content div
                ref={(el) => (contentRefs.current[index] = el)}
                // Smoothly transition from 0 to the measured height
                style={{
                  maxHeight: openIndex === index ? contentHeight : 0,
                }}
